...
<head>
	...
	<title> Team Sarana| Administrator Login</title>
	<link href="{{url('admin_assets/css/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ url('admin_assets/font-awesome/css/font-awesome.css') }}" rel="stylesheet">
...
<body class="gray-bg">
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			...
			<p class="m-t"> <strong>Copyright</strong>  copy: {{ date("Y") }} </p>
			<!-- {{ get_section_content('project', 'site_title') }} & -->
			<p class="m-t">Developed by - <a href="" target="_blank">Team Sarana ES1</a></p>
		</div>
	</div>
